  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-20 h-20 rounded-full bg-safe/20 flex items-center justify-center mb-6"
      >
      ...
      <div className="bg-surface-light rounded-2xl p-5 w-full max-w-xs mb-6">
        <h3 className="text-xs uppercase tracking-wider text-text-muted mb-3">What happens next</h3>
      ...
      <p className="text-text-muted text-xs max-w-xs">
        If you need immediate support, the <span className="text-primary-light font-medium">988 Suicide &amp; Crisis Lifeline</span> is available 24/7.
      </p>
    </motion.div>
  );
}
